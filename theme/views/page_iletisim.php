  ...
  <div class="mx-auto max-w-7xl py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
    <div class="relative bg-white shadow-xl">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3">
        <!-- Contact information -->
        <div class="relative overflow-hidden bg-[#7e6561] py-10 px-6 sm:px-10 xl:p-12">
          ...
          <h3 class="text-lg font-medium text-white">Randevu Al</h3>
          <p class="mt-6 max-w-3xl text-base text-indigo-50">Tedavilerimiz Hakkında Bilgi Almak ya da Bilgi Almak İçin Hemen Randevu Alın.</p>
          <dl class="mt-8 space-y-6">
            <dt><span class="sr-only">Telefon Numaramız</span></dt>
            <dd class="flex text-base text-indigo-50">
              ...
              <a href="tel:+90<?=$site_data->phone;?>">
              <span class="ml-3"><?=$site_data->phone;?></span>
              </a>
            </dd>
            <dt><span class="sr-only"><?=$site_data->email;?></span></dt>
            <dd class="flex text-base text-indigo-50">
          ...
          <ul role="list" class="mt-8 flex space-x-12">
            <li>
              <a class="text-indigo-200 hover:text-indigo-100" href="<?=$site_data->facebook;?>">
            ...
            <li>
              <a class="text-indigo-200 hover:text-indigo-100" href="<?=$site_data->instagram;?>">
            ...
            <li>
              <a class="text-indigo-200 hover:text-indigo-100" href="<?=$site_data->twitter;?>">
        ...
        <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
          <h3 class="text-lg font-medium text-gray-900">Hemen Randevu Al</h3>
          <form action="#" method="POST" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
          <?=form_open('send_mail',array('name'=>'iletisim-formu','class'=>'form-contact','id'=>'contactform'));?>
            <div>
              <label for="first-name" class="block text-sm font-medium text-gray-900">İsminiz</label>
              <div class="mt-1">
            ...
            <div>
              <label for="last-name" class="block text-sm font-medium text-gray-900">Soyisminiz</label>
              <div class="mt-1">
            ...
            <div>
              <label for="email" class="block text-sm font-medium text-gray-900">Eposta</label>
              <div class="mt-1">
            ...
            <div class="sm:col-span-2">
              <div class="flex justify-between">
                <label for="message" class="block text-sm font-medium text-gray-900">Mesajınız</label>
              </div>
              <div class="mt-1">
            ...
            <div class="sm:col-span-2 sm:flex sm:justify-end">
              <button type="submit" class="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-[#7e6561] px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-amber-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">Gönder</button>
            </div>
            <?=form_close();?>
          </form>
        </div>
